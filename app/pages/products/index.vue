 ...
 <v-row class="ma-0 mt-6 pa-0" >
  ...
  <v-col cols="12" md="3" class="pa-0 pl-4">
    <div class="filters-wrapper">
      <ProductsFilters v-model:search-query="searchQuery" @search="handleSearch" />
    </div>
  </v-col>
  ...
  <v-col cols="12" md="9" class="pa-0">
    ...
    <v-row v-else-if="filteredProducts?.length" class="ma-0 pa-0">
      <v-col cols="12" class="pa-0">
        <ProductsSelectedFilters :search-query="appliedSearchQuery" @clear-search="handleClearSearch"/>
      </v-col>
      <v-col
    ...
    <v-row v-else-if="data?.length && !filteredProducts?.length" class="ma-0 pa-0">
      <v-col cols="12" class="pa-0">
        <ProductsSelectedFilters :search-query="appliedSearchQuery" @clear-search="handleClearSearch"/>
      </v-col>
